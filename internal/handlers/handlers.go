...
import (
	...
	"github.com/daniel548604106/go-bookings/internal/forms"
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request){
	...
	// Cast the type from string to bytes
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request){
	...
	// Type assertion to get the reservation from the session
...
// Returns a JSON response for availability
func (m *Repository) AvailibilityJSON(w http.ResponseWriter, r *http.Request){

	json.NewEncoder(w).Encode(jsonReponse{OK: true, Message: "Available!"})
}
